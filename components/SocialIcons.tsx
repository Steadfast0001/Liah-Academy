...
export function TikTokIcon({ size = 18 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
      <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64c.298-.002.595.042.88.13V9.4a6.33 6.33 0 0 0-1-.08A6.34 6.34 0 0 0 3 15.66a6.34 6.34 0 0 0 10.86 4.45 6.3 6.3 0 0 0 1.83-4.44V8.41a8.3 8.3 0 0 0 4.9 1.58V6.54a4.83 4.83 0 0 1-1-.05z"/>
    </svg>
  );
}
...
export default function SocialLinksList({ iconSize = 18 }: { iconSize?: number }) {
  return (
    <div className="social-links-grid" style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
      ...
      <a 
        href="https://www.instagram.com/p/DZ7omcLtYKT/" 
        target="_blank" 
        rel="noopener noreferrer" 
        className="social-circle-link" 
      ...
      <a 
        href="https://www.tiktok.com/@liahacademy0" 
        target="_blank" 
        rel="noopener noreferrer" 
        className="social-circle-link" 
        aria-label="TikTok"
